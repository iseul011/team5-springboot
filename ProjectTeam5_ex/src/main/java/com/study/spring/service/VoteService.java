...
public class VoteService {
    ...
    private void sendVoteCreatedMessages(Vote vote, Long voteId) {
        ...
        // 모든 참여자에게 메시지 전송
        List<String> recipientIds = vote.isOpenToAllFriends() ? 
        		getAllFriendIds(vote.getMemId()) : vote.getParticipantIds();
    ...
    public List<Vote> getListMyVote(String memId) {
    	...
    	System.out.println("보트 서비스 내 투표 리스트 voteRepository."
    			+ "findByMemIdAndIsEnded(memId, false : "+ voteRepository.findByMemId(memId));
